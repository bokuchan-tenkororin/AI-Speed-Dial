...
const I18N={
 ja:{title:"AI Speed Dial \u8a2d\u5b9a",lblTheme:"\u30c6\u30fc\u30de:",optSystem:"\u30b7\u30b9\u30c6\u30e0\u8a2d\u5b9a\u306b\u5408\u308f\u305b\u308b",optLight:"\u30e9\u30a4\u30c8\u30e2\u30fc\u30c9",optDark:"\u30c0\u30fc\u30af\u30e2\u30fc\u30c9",lblCols:"\u6a2a\u306e\u6570:",lblRows:"\u7e26\u306e\u6570:",lblNewTab:"\u65b0\u898f\u30bf\u30d6\u3092\u7f6e\u304d\u63db\u3048\u308b",lblHome:"\u30db\u30fc\u30e0\u30dc\u30bf\u30f3\u3092\u7f6e\u304d\u63db\u3048\u308b",hIcons:"\u30a2\u30a4\u30b3\u30f3\u7de8\u96c6",thOrder:"\u9806",thIcon:"\u30a2\u30a4\u30b3\u30f3",thName:"\u540d\u524d",thUrl:"URL",thImg:"\u753b\u50cfURL",thAct:"\u64cd\u4f5c",add:"+ \u8ffd\u52a0",reset:"\u521d\u671f\u5316",save:"\u4fdd\u5b58",del:"\u524a\u9664",lblSearch:"\u691c\u7d22\u30a8\u30f3\u30b8\u30f3:",lblCustom:"\u30ab\u30b9\u30bf\u30e0URL:",customHelp:"%s \u3092\u691c\u7d22\u8a9e\u306b\u7f6e\u304d\u63db\u3048\u307e\u3059",optGAi:"Google AI\u30e2\u30fc\u30c9",optG:"Google",optBing:"Bing",optDDG:"DuckDuckGo",optCustom:"\u30ab\u30b9\u30bf\u30e0"},
 en:{title:"AI Speed Dial Settings",lblTheme:"Theme:",optSystem:"Follow system",optLight:"Light",optDark:"Dark",lblCols:"Columns:",lblRows:"Rows:",lblNewTab:"Replace new tab",lblHome:"Replace home button",hIcons:"Edit Icons",thOrder:"#",thIcon:"Icon",thName:"Name",thUrl:"URL",thImg:"Image URL",thAct:"Action",add:"+ Add",reset:"Reset",save:"Save",del:"Delete",lblSearch:"Search Engine:",lblCustom:"Custom URL:",customHelp:"Use %s for query",optGAi:"Google AI Mode",optG:"Google",optBing:"Bing",optDDG:"DuckDuckGo",optCustom:"Custom"}
};
const tbody=document.querySelector('#tbl tbody');
const els={theme:document.getElementById('theme'),cols:document.getElementById('cols'),rows:document.getElementById('rows'),newTab:document.getElementById('enableNewTab'),home:document.getElementById('enableHome'),search:document.getElementById('searchEngine'),custom:document.getElementById('customUrl'),customBox:document.getElementById('customBox')};
let curLang='en';
...
document.getElementById('save').onclick=async()=>{
  ...
  // 古い lang 設定が残っていれば削除
  try{ await chrome.storage.sync.remove('lang'); }catch{}
  window.close()
};
